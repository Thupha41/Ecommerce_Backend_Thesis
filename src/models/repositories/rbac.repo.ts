...
class RbacRepo {
    ...
    async findAll<T extends Document>({ collection, limit, sort, page, filter = {} }: {
    ...
    async findById<T extends Document>({ collection, id, errorMessage }: {
        collection: Collection<T>;
        id: string;
        errorMessage: string;
    }) {
    ...
    async create<T extends Document>({ collection, data }: {
        collection: Collection<T>;
        data: any;
    }) {
    ...
    async update<T extends Document>({ collection, id, data, errorMessage }: {
        collection: Collection<T>;
        id: string;
        data: any;
        errorMessage: string;
    ...
    async delete<T extends Document>({ collection, id, errorMessage }: {
        collection: Collection<T>;
        id: string;
        errorMessage: string;
    }) {
    ...
    async exists<T extends Document>({ collection, filter }: {
        collection: Collection<T>;
        filter: object;
    }) {

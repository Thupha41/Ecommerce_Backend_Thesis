...
export const createRoleController = async (req: Request<ParamsDictionary, any, IUpsertRole>, res: Response) => {
...
export const getRoleByIdController = async (req: Request<ParamsDictionary & { role_id: string }>, res: Response) => {
...
export const deleteRoleController = async (req: Request<ParamsDictionary & { resource_id: string }>, res: Response) => {
  const { role_id } = req.params
  const { user_id } = req.decoded_authorization as TokenPayload
...
export const updateRoleController = async (req: Request<ParamsDictionary & { role_id: string }>, res: Response) => {
  const { role_id } = req.params
  const { user_id } = req.decoded_authorization as TokenPayload
...
export const getRoleListRBACController = async (req: Request, res: Response) => {
  const { user_id } = req.decoded_authorization as TokenPayload
